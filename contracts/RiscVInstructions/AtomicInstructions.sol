...
library AtomicInstructions {
  ...
  function execute_AMO_part2(MemoryInteractor mi, uint256 mmIndex, uint64 pc, uint32 insn, uint64 vaddr, int32 valr, int32 valm, uint64 wordSize)
  ...
  public returns(bool) {
    ...
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32(valr), int32(0), 32);
  }

  function execute_AMOADD_W(MemoryInteractor mi, uint256 mmIndex, uint64 pc, uint32 insn)
  public returns(bool) {
    (uint64 valm, uint64 valr, uint64 vaddr, bool succ) = execute_AMO_part1(mi, mmIndex, pc, insn, 32);
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32(valm + valr), int32(valm), 32);
  }
  ...
  public returns(bool) {
    (uint64 valm, uint64 valr, uint64 vaddr, bool succ) = execute_AMO_part1(mi, mmIndex, pc, insn, 32);
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32( valm < valr? valm : valr), int32(valm), 32);
  }
  ...
  public returns(bool) {
    (uint64 valm, uint64 valr, uint64 vaddr, bool succ) = execute_AMO_part1(mi, mmIndex, pc, insn, 32);
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32(uint32(valm) < uint32(valr)? valm : valr), int32(valm), 32);
  }
  ...
  public returns(bool) {
    ...
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32(valr), int32(0), 64);
  }

  function execute_AMOADD_D(MemoryInteractor mi, uint256 mmIndex, uint64 pc, uint32 insn)
  public returns(bool) {
    (uint64 valm, uint64 valr, uint64 vaddr, bool succ) = execute_AMO_part1(mi, mmIndex, pc, insn, 64);
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32(valm + valr), int32(valm), 64);
  }
  ...
  public returns(bool) {
    (uint64 valm, uint64 valr, uint64 vaddr, bool succ) = execute_AMO_part1(mi, mmIndex, pc, insn, 64);
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32( valm < valr? valm : valr), int32(valm), 64);
  }
  ...
  public returns(bool) {
    (uint64 valm, uint64 valr, uint64 vaddr, bool succ) = execute_AMO_part1(mi, mmIndex, pc, insn, 64);
    return execute_AMO_part2(mi, mmIndex, pc, insn, vaddr, int32(uint32(valm) < uint32(valr)? valm : valr), int32(valm), 64);
  }
