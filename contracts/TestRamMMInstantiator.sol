...
contract TestRamMMInstantiator is InstantiatorImpl, MMInterface, Decorated {
    //
    // TESTRAM-SPECIFIC CODE
    //
    ...
    function htifExit(uint256 _index)
        public
        onlyInstantiated(_index)
        returns (uint64)
    {
    ...
    //
    // UNMODIFIED MMINSTANTIATOR CODE
    //
